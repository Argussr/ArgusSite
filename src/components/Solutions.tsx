...
const Solutions: React.FC = () => {
  const features = [
    ...
    {
      icon: <BellRing className="w-12 h-12 text-secondary" />,
    ...
    {
      icon: <File className="w-12 h-12 text-secondary" />,
  ...
  return (
    <section id="soluções" className="py-20 bg-accent">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-secondary max-w-2xl mx-auto rounded-lg">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-12">
          ...
          <div className="md:w-1/2 flex flex-col justify-center">
            ...
            <button className="mt-8 bg-primary hover:bg-primary-light/90 hover:text-secondary text-accent  py-3 px-6 rounded-md transition-all transform hover:scale-105 font-medium self-start">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="bg-accent-light p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow"
            >
